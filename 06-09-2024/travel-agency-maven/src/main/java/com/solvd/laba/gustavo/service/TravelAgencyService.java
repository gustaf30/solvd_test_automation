...
public class TravelAgencyService {
    ...
    public void addOrder(Order order, TravelAgency travelAgency) {
        CustomList<Order> orders = travelAgency.getOrdersList();
        orders.addAtEnd(order);
        travelAgency.setOrdersList(orders);
    }
